...
if [[ $(which php) == "" ]]; then
  ...
  DEBIAN_FRONTEND=noninteractive sudo apt install -y php7.3 php7.3-cli php7.3-soap php7.3-fpm php7.3-gd php7.3-mysql libapache2-mod-php7.3 libapache2-mod-fcgid
...
if [[ $(which apache2) == "" ]]; then
  ...
  DEBIAN_FRONTEND=noninteractive sudo a2enmod ssl
  stop_apache2_ubuntu
fi
if [[ $(which nginx) == "" ]]; then
